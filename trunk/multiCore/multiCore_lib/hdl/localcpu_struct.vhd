...
ARCHITECTURE struct OF localCPU IS
   ...
   FOR ALL : AluCont USE ENTITY multiCore_lib.AluCont;
   FOR ALL : CLU USE ENTITY multiCore_lib.CLU;
   FOR ALL : DataRtn USE ENTITY multiCore_lib.DataRtn;
   FOR ALL : Decode USE ENTITY multiCore_lib.Decode;
   FOR ALL : EXMEM_REG USE ENTITY multiCore_lib.EXMEM_REG;
   FOR ALL : FwdUnit USE ENTITY multiCore_lib.FwdUnit;
   FOR ALL : IDEX_REG USE ENTITY multiCore_lib.IDEX_REG;
   FOR ALL : IFID_REG USE ENTITY multiCore_lib.IFID_REG;
   FOR ALL : J_JAL USE ENTITY multiCore_lib.J_JAL;
   FOR ALL : MEMWB_REG USE ENTITY multiCore_lib.MEMWB_REG;
   FOR ALL : PcBlock USE ENTITY multiCore_lib.PcBlock;
   FOR ALL : ShiftXtd USE ENTITY multiCore_lib.ShiftXtd;
   FOR ALL : alu USE ENTITY multiCore_lib.alu;
   FOR ALL : registerFile USE ENTITY multiCore_lib.registerFile;
   -- pragma synthesis_on
