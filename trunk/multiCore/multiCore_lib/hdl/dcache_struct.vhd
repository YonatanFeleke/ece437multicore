...
ARCHITECTURE struct OF dcache IS
   ...
   FOR ALL : dCacheCLU USE ENTITY multiCore_lib.dCacheCLU;
   FOR ALL : data16x184 USE ENTITY multiCore_lib.data16x184;
   FOR ALL : linkregister USE ENTITY multiCore_lib.linkregister;
   -- pragma synthesis_on
...
BEGIN
   ...
   -- HDL Embedded Text Block 2 linkmux
