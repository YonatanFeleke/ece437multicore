...
ARCHITECTURE struct OF localCPU IS
   ...
   -- Implicit buffer signal declarations
   SIGNAL Freeze_internal : std_logic;
...
BEGIN
   ...
   -- HDL Embedded Text Block 1 InputIF
     IF_PCSkip <= '1' when (HALT1 = '1') else       -- Don't change PC when HALT1 or waiting for dcache
                  ...
                  '0';
     Freeze_internal <= '1' when cpuwait ='1' else
   ...
   ID_FLUSH <= '1' WHEN (EX_MEM2REG ='1' AND (EX_RT = RS OR EX_RT=RT)) else -- lw ll and SC uses RT as dest
   ...
   MEM_MEM2REG <= MEM_MEM2REG_internal; -- read in outputs
